...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Marquee brand names';
    displayName: 'Brand';
    pluralName: 'brands';
    singularName: 'brand';
  };
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useSerifStyle: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
  };
}
...
export interface ApiContactSectionContactSection
  ...
  info: {
    description: 'Inner circle / contact block';
...
export interface ApiFooterSectionFooterSection extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Footer credits and tagline';
  ...
  attributes: {
    copyrightLine: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creditEyebrow: Schema.Attribute.String & Schema.Attribute.Required;
    designerFirstName: Schema.Attribute.String & Schema.Attribute.Required;
    designerLastName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    punchline: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiPageHeadingPageHeading extends Struct.CollectionTypeSchema {
  collectionName: 'page_headings';
  info: {
    description: 'Section titles (catalogue, reviews, faq)';
    displayName: 'Page Heading';
    pluralName: 'page-headings';
    singularName: 'page-heading';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-heading.page-heading'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['catalogue', 'reviews', 'faq']> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    titleLine1: Schema.Attribute.String & Schema.Attribute.Required;
    titleLine2: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::page-heading.page-heading': ApiPageHeadingPageHeading;
